...
struct ContentGroup: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case advURL = "advUrl"
        case offerContentList, trailerInfo
    }
}
...
struct ContentList: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case advURL = "advUrl"
        case offerList, metaList, openingStartTime, openingEndTime, closingTime, thumbnailPosterOld, thumbnailPosterNew, trailerInfo
    }
}
...
struct OfferList: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case pointPolicyID = "pointPolicyId"
